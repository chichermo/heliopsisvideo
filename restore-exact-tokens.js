// Script para insertar los tokens exactos con sus passwords originales
const tokens = [
...
console.log('🔧 INSTRUCCIONES PARA INSERTAR TOKENS EXACTOS:');
console.log('===============================================');
console.log('');
console.log('Necesito crear un endpoint especial para insertar estos tokens exactos.');
console.log('Voy a modificar el código para agregar esta funcionalidad.');
console.log('');
console.log('📋 TOKENS A INSERTAR (30 tokens):');
console.log('');

tokens.forEach((tokenData, index) => {
    console.log(`${index + 1}. ${tokenData.email}`);
    console.log(`   Token: ${tokenData.token}`);
    console.log(`   Password: ${tokenData.password}`);
    console.log(`   URL: https://heliopsis-video.onrender.com/watch-simple/${tokenData.token}`);
    console.log('');
});

console.log('💡 SOLUCIÓN: Voy a crear un endpoint especial que permita insertar estos tokens exactos.');
console.log('   Esto mantendrá los tokens originales que ya enviaste a los usuarios.');
