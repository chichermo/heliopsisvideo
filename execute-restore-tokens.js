...
// Script para ejecutar la restauración de tokens exactos
const tokens = [
...
async function restoreTokens() {
    console.log('🔄 Iniciando restauración de tokens exactos...');
    console.log(`📊 Total de tokens a restaurar: ${tokens.length}`);
    ...
    try {
        ...
        if (result.success) {
            ...
            console.log(`📊 Tokens insertados: ${result.insertedCount}`);
            ...
            console.error('❌ Error restaurando tokens:', result.error);
        }
